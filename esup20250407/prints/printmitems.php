...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <p class="text-center" style="font-size: smaller; font-weight: bold;">Colombo Dockyard PLC <br> P.O. Box: 906, Port of Colombo, Colombo 15 <br> Tender for the supply of Foods - Miscellaneous Items</p>
            <div class="row">
