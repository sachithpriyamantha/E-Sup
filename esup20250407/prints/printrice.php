...
<body>
    ...
    while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC)) {
        ...
        $supply_end_period = date('Y-m-d', strtotime($enddatee . ' + 6 days'));
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <p class="text-center" style="font-size: smaller; font-weight: bold;">Colombo Dockyard PLC <br> P.O. Box: 906, Port of Colombo, Colombo 15 <br> Tender for the supply of Foods - Rice</p>
            <div class="row">
                <p style="font-size: smaller; font-weight: bold">Supplier Name and Address update: <?php echo $suppiler_name  ?> </p>
                <div class="col-4">
                    <p style="font-size: smaller; font-weight: bold;">Supply Period: <?php echo $enddatee ?> To <?php echo $supply_end_period ?></p>
                </div>
