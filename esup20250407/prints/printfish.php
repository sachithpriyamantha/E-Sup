...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <p class="text-center" style="font-size: smaller; font-weight: bold;">Colombo Dockyard PLC <br> P.O. Box: 906, Port of Colombo, Colombo 15 <br> Tender for the supply of Foods - Fish</p>
            <div class="row">
            ...
            <!-- <div class="col-6">
                    <table class=" table-bordered" style="font-size: 9px;">
                        <thead>
                            <tr>
                                <th style="padding-left: 20px; padding-right: 10px;">S/No</th>
                                <th style="padding-left: 30px; padding-right: 20px;">Description</th>
                                <th style="padding-left: 20px; padding-right: 10px;">Unit</th>
                                <th style="padding-left: 20px; padding-right: 10px;">Price</th>
                            </tr>
                        </thead>
