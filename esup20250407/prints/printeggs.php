...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <p class="text-center" style="font-size: smaller; font-weight: bold;">Colombo Dockyard PLC <br> P.O. Box: 906, Port of Colombo, Colombo 15 <br> Tender for the supply of Foods - Eggs</p>
            <div class="row">
                ...
                <div class="col-4">
                    <p style="font-size: smaller; font-weight: bold;">Bidd Closed Date: <?php echo $bidclose_date ?> </p>
                </div>
                <div class="col-4">
