...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <p class="text-center" style="font-size: smaller; font-weight: bold;">Colombo Dockyard PLC <br> P.O. Box: 906, Port of Colombo, Colombo 15 <br> Tender for the supply of Foods</p>
            <div class="row">
                <p style="font-size: smaller; font-weight: bold">Supplier Name and Address: <?php echo $suppiler_name ?> </p>
                <div class="col-4">
                ...
                <div class="col-12">
                    <p style="font-size: smaller; font-weight: bold;">"Due to the New Year vacation, the supply period for the Week 15 tender has been extended until April 22nd."</p>
                </div>
            </div>
            <div style="margin: auto; padding-left: 25% ">
                <table class="table-bordered" style="font-size: 9px; ">
                    ...
                    <tbody>
                        ...
                        $tsql = "SELECT MMC_DESCRIPTION,MMC_UNIT, mtt_price FROM mms_tenderprice_transactions
                            INNER JOIN mms_material_catalogue ON mms_material_catalogue.MMC_MATERIAL_CODE = mms_tenderprice_transactions.mtt_material_code 
                            AND mms_tenderprice_transactions.mtt_supplier_code = '" . $var_value . "' AND mms_tenderprice_transactions.mtt_tender_no = '" . $tenderno_val . "'  
