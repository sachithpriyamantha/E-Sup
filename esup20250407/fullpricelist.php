...
// Modified query to include MMC_MATERIAL_SPEC
$query = "SELECT
  ...
  c.mmc_unit AS Unit,
  c.mmc_material_spec AS Material_Spec"; // Added Material Spec column

foreach ($datalist as $key => $value) {
    $supplier_name = mysqli_real_escape_string($con, $value["msd_supplier_name"]);
